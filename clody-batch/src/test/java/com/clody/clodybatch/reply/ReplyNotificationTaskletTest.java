...
//
//    when(replyScheduleService.findSchedulesToNotify(any(LocalDateTime.class))).thenReturn(Collections.singletonList(schedule));
//    when(replyNotificationService.getReplyAlarmForUser(1L)).thenReturn(alarm);
//
...
//    verify(replyScheduleService).updateSchedulesAsSent(schedule);
//  }
//
//}
