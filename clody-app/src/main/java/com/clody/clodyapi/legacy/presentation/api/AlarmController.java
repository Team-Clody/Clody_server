package com.clody.clodyapi.legacy.presentation.api;
...
public interface AlarmController {
  ...
  ResponseEntity<ApiResponse<AlarmResponse>> getAlarmInfo(
      @RequestHeader(HeaderConstants.AUTHORIZATION) @Parameter(name = "Authorization", description = "클라이언트의 access Token", required = true) final String accessToken
  );
